...
interface ICurveFi {
    ...
    function remove_liquidity(uint256 _amount, uint256[5] calldata amounts) external;
    ...
    function exchange_underlying(uint256 _from, uint256 _to, uint256 _amountFrom, uint256 _minTo) external;
    ...
    function get_dy_underlying(uint256 _fromIndex, uint256 _toIndex, uint256 _from_amount) external view returns (uint256);
